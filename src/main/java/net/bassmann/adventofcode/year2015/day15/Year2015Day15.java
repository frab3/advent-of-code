 ...
 *
 * <p>Today, you set out on the task of perfecting your milk-dunking cookie recipe. All you have to
 * do is find the right balance of ingredients.
 *
 * <p>Your recipe leaves room for exactly 100 teaspoons of ingredients. You make a list of the
 ...
 *
 * <p>For example, given the ingredients above, if you had instead selected 40 teaspoons of
 ...
 *
 * <p>Given the ingredients in your kitchen and their properties, what is the total score of the
 * highest-scoring cookie you can make with a calorie total of 500?
 */
public class Year2015Day15 extends AbstractDay {

  private CookieMix cookieMix;
  ...
  public String solvePart1() {
    int max = getCookieMix().findBestTotalScore(0);
    return Integer.toString(max);
  }

  @Override
  public String solvePart2() {
    int max = getCookieMix().findBestTotalScore(500);
    return Integer.toString(max);
  }

  private CookieMix getCookieMix() {
    if (cookieMix == null) {
      final List<Ingredient> ingredients =
          getRiddleInput().lines().map(Ingredient::fromString).collect(Collectors.toList());
      cookieMix = new CookieMix(ingredients);
    }
    return cookieMix;
  }
}
