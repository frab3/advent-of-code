package net.bassmann.adventofcode.year2015.day22;
 ...
 *
 * <p>Little Henry Case decides that defeating bosses with swords and stuff is boring. Now he's
 * playing the game with a wizard. Of course, he gets stuck on another boss and needs your help
 * again.
 *
 * <p>In this version, combat still proceeds with the player and the boss taking alternating turns.
 ...
 *
 * <p>Since you're a wizard, you don't get to wear armor, and you can't attack normally. However,
 * since you do magic damage, your opponent's armor is ignored, and so the boss effectively has zero
 * armor as well. As before, if armor (from a spell, in this case) would reduce damage below 1, it
 * becomes 1 instead - that is, the boss' attacks always deal at least 1 damage.
 *
 * <p>On each of your turns, you must select one of your spells to cast. If you cannot afford to
 ...
 *
 * <ul>
 *   <li>Magic Missile costs 53 mana. It instantly does 4 damage.
 *   <li>Drain costs 73 mana. It instantly does 2 damage and heals you for 2 hit points.
 *   <li>Shield costs 113 mana. It starts an effect that lasts for 6 turns. While it is active, your
 *       armor is increased by 7.
 *   <li>Poison costs 173 mana. It starts an effect that lasts for 6 turns. At the start of each
 *       turn while it is active, it deals the boss 3 damage.
 *   <li>Recharge costs 229 mana. It starts an effect that lasts for 5 turns. At the start of each
 ...
 *
 * <p>For example, suppose the player has 10 hit points and 250 mana, and that the boss has 13 hit
 * points and 8 damage:
 *
 * <pre>
 * -- Player turn --
 ...
 */
public class Year2015Day22 extends AbstractDay {
